    ...
    >
        ...
        >
            ...
            >
                <div
                    v-show="show"
                    class="relative transform overflow-hidden rounded-2xl bg-white shadow-[0_20px_50px_rgba(0,0,0,0.15)] transition-all sm:mx-auto sm:w-full border border-gray-100/50"
                    :class="maxWidthClass"
                >
                    <slot v-if="showSlot" />
                </div>
